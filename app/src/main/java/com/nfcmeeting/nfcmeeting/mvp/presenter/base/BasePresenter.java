...
package com.nfcmeeting.nfcmeeting.mvp.presenter.base;
...
import com.nfcmeeting.nfcmeeting.http.core.HttpProgressSubscriber;
import com.nfcmeeting.nfcmeeting.http.core.HttpResponse;
import com.nfcmeeting.nfcmeeting.http.core.HttpSubscriber;
import com.nfcmeeting.nfcmeeting.http.error.HttpError;
import com.nfcmeeting.nfcmeeting.http.error.HttpErrorCode;
import com.nfcmeeting.nfcmeeting.http.error.HttpPageNoFoundError;
import com.nfcmeeting.nfcmeeting.http.error.UnauthorizedError;
...
public abstract class BasePresenter<V extends IBaseContract.View> implements IBaseContract.Presenter<V> {
    ...
    protected LoginService getLoginService() {
        return AppRetrofit.INSTANCE
                .getRetrofit(AppConfig.NFCMEETING_BASE_URL, null)
                .create(LoginService.class);
    }

    protected LoginService getLoginService(String token) {
        return AppRetrofit.INSTANCE
                .getRetrofit(AppConfig.NFCMEETING_BASE_URL, token)
                .create(LoginService.class);
    }
